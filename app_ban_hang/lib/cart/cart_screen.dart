...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _buildBody(blocHome, listProd),
      bottomNavigationBar: _buildBottomNavBar(blocHome),
    );
  }

  MyContainer _buildBottomNavBar(BlocHome blocHome) {
    return MyContainer(
      child: Padding(
  ...
  MyContainer _buildBody(BlocHome blocHome, List<int> listProd) {
    return MyContainer(
      child: Column(children: [
        const Divider(),
        SizedBox(
            height: (blocHome.cart.isEmpty ? 5 : blocHome.cart.length) * 80,
